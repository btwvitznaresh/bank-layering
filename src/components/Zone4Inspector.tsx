...
export const Zone4Inspector: React.FC = () => {
  const { selectedAccountId, setSelectedAccountId, setExpandedNodeId, addToast } = useGlobalState();
            ...
            <div className="p-5 border-b border-[var(--border-subtle)] bg-[rgba(0,229,255,0.02)]">
              ...
              {aiState === 'idle' ? (
                ...
                <div className="bg-black/30 border border-[rgba(0,245,255,0.15)] rounded p-3 text-xs leading-relaxed text-white/90 font-['DM_Sans'] shadow-inner">
                  ...
                  {aiState === 'done' && (
                    <button 
                      onClick={() => addToast('Added node to active investigation framework', 'success')}
            ...
            <div className="p-5 flex flex-col gap-3">
              ...
              <button 
                onClick={() => {
                   ...
                   addToast(`Showing direct network of ${account.name} — ${count} connected accounts`, 'info');
                }}
